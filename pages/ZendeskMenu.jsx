    ...
    return (
      <VStack {...BodyVstackCss}>
        ...
        <VStack display={ taskType === "audit" ? "inline" : "none" } flexDirection="column">
          ...
          <p>Ensure that your initial URL is set to <i><strong>https://familysearch.zendesk.com/hc/en-us/</strong></i> before beginning. You may edit the initial URL by clicking 'Edit Wiki Paths'.</p>
        </VStack>
        ...
        {taskType === "scrape" && (
          <>
            <TextInput
              ...
              placeholder="e.g., https://familysearch.zendesk.com/hc/en-us"
            />
          </>
        )}
...
const ZendeskMenu = () => {
  ...
  const [zendeskUrl, setZendeskUrl] = useState("https://familysearch.zendesk.com/hc/en-us");
